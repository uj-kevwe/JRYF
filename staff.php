...
<html>
    ...
    <body>
        <header style="position:fixed; top:0; background:rgba(0,0,0,0.5);color:#f1f1f1;
                width:100%;padding:0px; z-index: 1">
            <div class="topnav" id="myTopnav">
                <div class= "col-lg-9 col-md-7 col-sm-12 col-xs-12" style="float:right; height:fit-content" >

                    <span style="font-size:1.2vw;cursor:pointer; float:right;padding-right:1vw;margin-top:0;
                          " onclick="openNav()">&#9776;Program Menu</span>
                    <div class="container">
                        <div class="row">
                            <!-- The overlay -->
                ...
                <a href="index.php" class="active"><img src="Images/JRFoundation1.png" style="height:3.3vw"></a>
                <a href="index.php">Home</a>
                <a href="about.php">About</a>
                <a href="#partners">Partners</a>
                <a href="#media">Media</a>
                <a href="javascript:void(0);" class="icon" onclick="myFunction()">
                    <i class="fa fa-bars" style="font-size: 1.2vw">Other Menu</i>
                </a>
            </div>
        </header>
        <section id="teammembers">
            <div class="container">
                <div class="row">
                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                        <img src="Images/clear-water2.jpg" style="position:fixed;top:0; left:0; z-index: -1">
            ...
            <div class="container">
                <div class="container">
                    <div class="row" style="position:relative;top:4vw; z-index: 1">
                        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                            <h1 style="text-align: center; color:white">Meet The JRYF TEAM</h1>
                        </div>
                    </div>
                </div>
                <div class="row" style="position: relative; top:6vw">
                    <div class="col-md-4 col-sm-6">
                        <div class="our-team">
                            <div class="pic">
                                ...
                                <div class="team-info">
                                    <h3 class="title">Jayden Robinson</h3>
                                    <span class="post">Founder</span>
                                </div>
                            </div>
                            <p class="description">
                                A young, energetic and dynamic entrepreneur
                            </p>
                            <hr>
                        </div>
                    </div>
                    <div class="col-md-4 col-sm-6">
                        <div class="our-team">
                            <div class="pic">
                                ...
                                <div class="team-info">
                                    <h3 class="title">Helen Onwuka</h3>
                        ...
                        <div class="our-team">
                            <div class="pic">
                                ...
                                <div class="team-info">
                                    ...
                                    <span class="post">IT Manager</span>
                                </div>
                            </div>
                            <p class="description">
        ...
        <footer style="position:relative; bottom:-20; left:0; background:rgba(0,0,0,0.5);color:#f1f1f1;
                width:100%;padding:1vw">
            <div class="container">
                <div class="row">
                    <div class="col-lg-4 col-md-4 col-sm-12 col-xs-12">
                        <div class="footer-info-single"> 
                            <img src="Images/RealJR.png" class="img-responsive center-block" alt="" 
                                 style="padding-top:1vw; height:4vw ; float:left">
                            <div class="social-media" style="float:right">
                                ...
                                <ul class="list-inline">
                                    ...
                                    <li><a href="#" title=""><i class="fa fa-linkedin"></i>&nbsp;Instagram</a></li><br><hr>
